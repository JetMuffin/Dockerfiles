...
# sidecar
docker pull registry.cn-hangzhou.aliyuncs.com/jetmuffin/k8s-dns-sidecar:latest
docker tag registry.cn-hangzhou.aliyuncs.com/jetmuffin/k8s-dns-sidecar:latest k8s.gcr.io/k8s-dns-sidecar-amd64:1.14.5
...
# k8s-dns-kube-dns
docker pull registry.cn-hangzhou.aliyuncs.com/jetmuffin/k8s-dns-kube-dns:latest
docker tag registry.cn-hangzhou.aliyuncs.com/jetmuffin/k8s-dns-kube-dns:latest k8s.gcr.io/k8s-dns-kube-dns-amd64:1.14.5

# kube-dashboard
# kubernetes-dashboard
docker pull registry.cn-hangzhou.aliyuncs.com/jetmuffin/kubernetes-dashboard:latest
docker tag registry.cn-hangzhou.aliyuncs.com/jetmuffin/kubernetes-dashboard:latest k8s.gcr.io/kubernetes-dashboard-amd64:v1.8.1
